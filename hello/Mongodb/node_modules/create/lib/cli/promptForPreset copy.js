...
export async function promptForPreset(requested, template) {
    if (requested) {
        if (!(requested in template.presets)) {
            return new Error(`${requested} is not one of: ${Array.from(Object.keys(template.presets)).join(", ")}`);
        }
    ...
    if (prompts.isCancel(preset)) {
        return new Error("TODO: how to message on cancel?");
    }
...
//# sourceMappingURL=promptForPreset%20copy.js.map
...
import { z } from "zod";
import { validateNewDirectory, validateNumber, validatorFromSchema, } from "./validators.js";
...
describe("validateNewDirectory", () => {
    it("returns undefined when the directory does not exist", () => {
        ...
        expect(actual).toBe("That directory already exists. Please choose another one.");
    });

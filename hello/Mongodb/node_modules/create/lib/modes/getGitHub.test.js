...
describe("getOctokit", () => {
    it("throws an error when getGitHubAuthToken fails", async () => {
        ...
        await expect(getGitHub).rejects.toMatchInlineSnapshot(`[Error: Couldn't authenticate with GitHub. Either log in with \`gh auth login\` (https://cli.github.com) or set a GH_TOKEN environment variable.]`);
    });
...
//# sourceMappingURL=getGitHub.test.js.map